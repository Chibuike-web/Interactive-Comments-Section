...
replyBtns.forEach((replyBtn) => {
	replyBtn.addEventListener("click", (e) => {
		...
		const activeReplyInput = sendReplyBtn.closest("#reply-input-box");
		const replyTextArea = activeReplyInput.querySelector("#reply-input");
        ...
        `;
			...
			comment.textContent = replyTextArea.value;
